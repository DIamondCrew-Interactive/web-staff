---
title: "Architektura Image Service"
...
## Ověření výsledku
Public image GET 200 bez session; /api/media bez session 401; povolený účet vidí seznam. Služba nevrací hostové cesty, konfiguraci či credentials. [Deployment](docker-deployment.md), [Zabezpečení](security.md).
