---
title: "New DIA node: full control plane"
...
# New DIA node: full control plane
...
9. Nainstaluj [Staff Center](../11-staff-center/deployment.md) a [Public Status](../12-public-status/architecture.md); nastav Discord a shared proxy síť. Nezaměň veřejný login webu s oprávněním Panelu.
