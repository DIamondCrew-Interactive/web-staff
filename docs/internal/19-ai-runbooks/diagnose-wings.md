---
title: "Diagnose Wings"
category: 19-ai-runbooks
categoryTitle: "AI runbooks"
order: 252
audience: ["ai","admin"]
tags: ["diagnose-wings","runbook","AI"]
---

# Diagnose Wings

## GOAL
Restore node connectivity using evidence.
...
## READ FIRST
[Relevantní end-to-end návod](../20-troubleshooting/wings-offline.md)
...
## PROCEDURE
Prověř službu, Docker, FQDN/TLS/proxy, identity a IPAM. Tokeny nevypisuj.
