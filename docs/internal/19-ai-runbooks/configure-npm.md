...
order: 248
audience: ["ai","admin"]
tags: ["configure-npm","runbook","AI"]
---

# Configure NPM

## GOAL
Add or repair a specific reverse proxy host.
...
## READ FIRST
[Relevantní end-to-end návod](../07-nginx-proxy-manager/create-proxy-host.md)
...
## PROCEDURE
Ověř existující vhosty, upstream reachability a DNS. Měň jen cílový Proxy Host.
