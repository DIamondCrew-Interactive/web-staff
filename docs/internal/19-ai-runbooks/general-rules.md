---
title: "General AI operating rules"
...
# General AI operating rules

## GOAL
Determine target and perform only the authorized operation.
...
## READ FIRST
[Relevantní end-to-end návod](../01-getting-started/ai-entrypoint.md)
