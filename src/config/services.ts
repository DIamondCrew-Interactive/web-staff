...
export const services: Service[] = [
  { id: 'manager', name: 'DiamondCrew Interactive Server Manager', description: 'Správa herních serverů', url: 'https://panel.diamondcrew.net', enabled: true, status: 'OPERATIONAL', category: 'management', icon: 'panel', visual: 'datacenter' },
  { id: 'controller', name: 'DiamondCrew Interactive Server Controller', description: 'Rychlé ovládání a konzole', url: 'https://admin.diamondcrew.net', enabled: true, status: 'OPERATIONAL', category: 'management', icon: 'game', visual: 'console' },
  { id: 'proxy', name: 'DiamondCrew Interactive Proxy Manager', description: 'Správa proxy a HTTPS', url: 'https://proxy.diamondcrew.net', enabled: false, status: 'IN PROGRESS', category: 'management', icon: 'network', visual: 'network' },
  ...
  { id: 'status', name: 'DiamondCrew Interactive Services Status', description: 'Stav všech služeb', url: 'https://status.diamondcrew.net', enabled: true, status: 'OPERATIONAL', category: 'management', icon: 'status', visual: 'heartbeat' },
];
export const infrastructureServices: Service[] = [
  ...
  { id: 'images', name: 'DiamondCrew Interactive Image Service', description: 'Images & static asset delivery', url: 'https://img.dcrp.cz/manage', enabled: false, status: 'IN PROGRESS', category: 'infrastructure', icon: 'image' },
];
